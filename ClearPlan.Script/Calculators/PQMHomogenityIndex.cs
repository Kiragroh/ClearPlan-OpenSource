...
{
    class PQMHomogenityIndex
    {
        public static string GetHomogenityIndex(StructureSet structureSet, PlanningItemViewModel planningItem, Structure evalStructure, MatchCollection testMatch, Group evalunit)
        {
            ...
            var hi = (d2 - d98) / planDoseDouble;
            return string.Format("{0:0.000}", hi);
        }
    }
}
